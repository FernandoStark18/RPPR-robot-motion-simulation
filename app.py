...
# Análisis cinemático por la convención Denavit-Hartenberg de un robot RPPR
...
def configuracion_grafica():
	# Título del gráfico
	plt.title("Robót RPPR", x = 0.03, y = 30)
	# Límites del gráfico
	ax.set_xlim(-5,5)
	ax.set_ylim(-5,5)
	ax.set_zlim(0,5)
...
sld_d2 = Slider(ax2, "d2",0,3,valinit = 2)
